...
import com.aries.common.generator.common.component.AriesException;
import com.aries.common.generator.web.entity.ColumnEntity;
import com.aries.common.generator.web.entity.TableEntity;
...
public class GeneratorUtils {
	...
	public static Configuration getConfig(){
		try {
			...
			e.printStackTrace();
			throw new AriesException("获取配置文件失败！");
		}
	}
	...
	public static String getFileName(String template, String className, String packageName, String moduleName) {
		...
		if (template.contains("Mapper.xml.vm")) {
			return "main" + File.separator + "resources" + File.separator + "mappings" + File.separator + moduleName
	...
	public static void generatorCode(Map<String, Object> table, List<Map<String, Object>> columns,
      ...
      //列信息
        ...
        for(Map<String, Object> column : columns){
            ...
            //是否主键
            if ("PRI".equalsIgnoreCase(column.get("columnKey").toString()) && tableEntity.getPrimaryKey() == null) {
        ...
        for (String template : templates) {
            ...
            try {
                ...
                throw new AriesException("渲染模板失败，表名：" + tableEntity.getTableName(), e);
            }
        }
	}
